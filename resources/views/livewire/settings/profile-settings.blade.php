                ...
                <form wire:submit="updateProfile">
                    ...
                    @if(auth()->user()->google_id)
                        <div class="alert alert-info mb-4">
                            ...
                            <span>You signed up with Google. You can set a password here to enable email/password login. Leave current password blank if you haven't set one yet.</span>
                        </div>
                    @endif
